        ...
        >
          <span className="flex items-center gap-2">
            ...
            <span className="text-transparent bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 bg-clip-text font-semibold">
              میکروسازه پرو اکنون در دسترس است!
            </span>
          </span>
              ...
              <div className="relative z-10 flex items-center justify-between w-full gap-2">
                ...
                <div className="flex items-center gap-6">
                  <Link href="/" className="flex items-center gap-2">
                    <Flame className="w-6 h-6 text-[#da4dff]" />
                    <span className="font-semibold">میکروسازه</span>
                  </Link>
                ...
                <div
                  dir="rtl"
                  className="flex sm:hidden items-center justify-between w-full gap-4">
                  <ViewTransitionsLink
                    href="/docs/components/action-search-bar"
                    className="text-right text-sm text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors">
                    کامپوننت‌ها
                  </ViewTransitionsLink>
                  <ThemeToggle />
                </div>
