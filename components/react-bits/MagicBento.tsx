...
const cardData: BentoCardProps[] = [
  {
    color: '#060010',
    title: '+۱۱۰',
    description: 'کامپوننت‌های خلاقانه؛ کاملاً بهینه و در حال توسعه ماهانه',
    label: 'اجزای رابط کاربری'
  },
  {
    color: '#060010',
    title: '۴',
    description: 'نسخه مختلف؛ استک تکنولوژی مورد نظر خود را انتخاب کنید',
    label: 'تنوع فریم‌ورک'
  },
  {
    color: '#060010',
    title: '۱۰۰٪',
    description: 'رایگان و متن‌باز؛ محبوب توسعه‌دهندگان در سراسر دنیا',
    label: 'دسترسی آزاد'
  },
  {
    color: '#060010',
    title: '۳',
    description: 'ابزار اختصاصی؛ سرعت گردش کار خود را افزایش دهید',
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  useEffect(() => {
    ...
    const update = () => setIsLightTheme(detect());
    ...
    else if (mm && mm.addListener) mm.addListener(listener as any);
    ...
    return () => {
      ...
      else if (mm && mm.removeListener) mm.removeListener(listener as any);
      observer.disconnect();
    };
  }, []);
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const bgColor = isLightTheme ? '#ffffff' : card.color;
          const cardProps = {
              ...
              >
                <div className="magic-bento-card__header">
                  <ShinyText
                    ...
                    pauseOnHover={false}
                    disabled={false}
                    className='text-6xl lg:text-8xl font-bold mb-2'
                  />
                </div>
                <div className="magic-bento-card__content">
                  ...
                  <h4
                    ...
                    style={{ color: isLightTheme ? '#0f172a' : undefined }}
                  >
                    {card.label}
                  </h4>
                  <p
                    className="magic-bento-card__description"
                    style={{ color: isLightTheme ? '#6b7280' : undefined }}
                  >
                    {card.description}
                  </p>
                </div>
