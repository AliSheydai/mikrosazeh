...
export default function CurrencyTransfer() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("TRX-28974651")
    setCopied(true)
  ...
  return (
    <Card
      dir="rtl"
      className="w-full max-w-sm mx-auto p-6 min-h-[300px] flex flex-col justify-center bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 backdrop-blur-xs relative overflow-hidden font-sans"
    >
      ...
      <CardContent className="space-y-4 flex flex-col items-center justify-center relative z-10">
        ...
        >
          <motion.h2
            className="text-lg text-zinc-900 dark:text-zinc-100 tracking-tighter font-bold"
                ...
                <div className="text-xs text-zinc-700 dark:text-zinc-300 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center justify-between gap-1">
                      <span className="text-zinc-900 dark:text-zinc-100">۴</span>
                      <span className="text-zinc-900 dark:text-zinc-100" dir="ltr">اردیبهشت ۱۴۰۴</span>
                    </div>
                  </div>
                  <div className="flex justify-between">
                    <span>کارمزد:</span>
                    <span className="text-zinc-900 dark:text-zinc-100" dir="ltr">2.50 USD</span>
                  </div>
          ...
          <div className="pt-4 flex justify-center gap-3">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              ...
              >
                {showDetails ? "تراکنش مخفی" : "مشاهده جزئیات"}
                <motion.div animate={{ rotate: showDetails ? 90 : 0 }} transition={{ duration: 0.2 }} className="mr-2">
                  <ArrowLeft size={14} />
                </motion.div>
              </Button>
            </motion.div>
