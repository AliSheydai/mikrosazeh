...
const iconStyles = {
    ...
    message: "from-emerald-500/20 to-emerald-500/10 text-emerald-600 dark:from-emerald-400/20 dark:to-emerald-400/10 dark:text-emerald-400",
};
...
const ITEMS: ListItem[] = [
    {
        id: "1",
        title: "پیام‌رسان",
        description: 'امیر برای شما پیامی فرستاد: "سلام، نظرت در مورد پروژه چیه؟"',
        icon: MessageSquare,
        iconStyle: "message",
        time: "همین الان",
        badge: { text: "جدید", variant: "orange" },
    },
    {
        id: "2",
        title: "موسیقی",
        description: "لیست پخش روزانه شما با ۲۵ آهنگ جدید آماده است",
        icon: Music,
        iconStyle: "music",
        time: "۲ دقیقه پیش",
        badge: { text: "آهنگ", variant: "pink" },
    },
    {
        id: "3",
        title: "فروشگاه اپلیکیشن",
        description: "برنامه فیگما به نسخه ۲.۰ بروزرسانی شد",
        icon: Store,
        iconStyle: "store",
        time: "۵ دقیقه پیش",
        badge: { text: "بروزرسانی", variant: "indigo" },
    },
];
