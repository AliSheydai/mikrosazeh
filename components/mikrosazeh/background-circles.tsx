...
import { motion } from "framer-motion"; // توجه: در نسخه‌های جدید معمولاً از framer-motion استفاده می‌شود
...
export function BackgroundCircles({
    ...
    description = "توضیحات اختیاری در این قسمت قرار می‌گیرد",
    className,
    variant = "octonary",
...
export default function DemoCircles() {
    ...
    return (
        <>
            ...
            <div className="absolute top-12 left-12" dir="rtl">
                <button
                    type="button"
                    className="bg-slate-950 dark:bg-white text-white dark:text-slate-950 px-4 py-2 rounded-md z-10 text-sm font-medium shadow-lg hover:opacity-90 transition-opacity"
                    onClick={() => {
