...
export default function AIInput_Farsi() {
    ...
    return (
        <div className="p-4 min-w-full" dir="rtl">
            <div className="relative">
                <div className="relative flex flex-col border border-black/10 dark:border-white/10 rounded-xl bg-white dark:bg-zinc-900">
                    ...
                    <div className="h-14">
                        <div className="absolute left-3 right-3 bottom-3 flex items-center justify-between flex-row-reverse">
                            <button
                                type="button"
                                className={cn(
