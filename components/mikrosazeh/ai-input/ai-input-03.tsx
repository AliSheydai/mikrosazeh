        ...
        <div className="w-full py-4" dir="rtl">
            <div className="relative max-w-xl w-full mx-auto">
                <div className="relative border border-black/10 dark:border-white/10 focus-within:border-black/20 dark:focus-within:border-white/20 rounded-2xl bg-black/[0.03] dark:bg-white/[0.03]">
                    <div className="flex flex-col">
                        <div className="overflow-y-auto max-h-[200px]">
                            <Textarea
                                ...
                                className={cn(
                                    "max-w-xl w-full rounded-2xl pl-10 pr-3 pt-3 pb-3 placeholder:text-black/70 dark:placeholder:text-white/70 border-none focus:ring-3 text-black dark:text-white resize-none text-wrap bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 leading-[1.2] text-right",
                                    "min-h-[52px]",
                                    "max-h-[200px]"
                                )}
                                value={inputValue}
                    ...
                    <CornerLeftDown
                        className={cn(
                            "absolute left-3 top-3 w-4 h-4 transition-all duration-200 dark:text-white",
                            inputValue
                    ...
                    ({ text, icon: Icon, colors }) => (
                        ...
                        >
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-black/70 dark:text-white/70 whitespace-nowrap font-medium">
                                    {text}
                                </span>
                            </div>
                        </button>
