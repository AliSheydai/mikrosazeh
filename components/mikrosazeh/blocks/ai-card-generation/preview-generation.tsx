...
export const Preview = ({ isLoading, imageUrl }: PreviewProps) => {
    // ترجمه متون وضعیت در حال بارگذاری
    const availableTexts = [
        "در حال خلق شاهکار شما...",
        "انتخاب بهترین رنگ‌ها...",
        "اعمال لمس نهایی...",
    ];
    ...
    useEffect(() => {
        ...
        return () => clearInterval(interval);
    }, [isLoading, availableTexts.length]);

    return (
        <div className="aspect-video rounded-xl mb-4 flex items-center justify-center font-sans">
            {isLoading ? (
                    ...
                    <CardContent className="flex flex-col items-center gap-4 p-6">
                        ...
                        <div className="space-y-1 text-center" dir="rtl">
                            ...
                            <p className="text-xs text-zinc-500 dark:text-zinc-400">
                                این فرآیند معمولاً ۱۰ تا ۱۵ ثانیه زمان می‌برد
                            </p>
                        </div>
