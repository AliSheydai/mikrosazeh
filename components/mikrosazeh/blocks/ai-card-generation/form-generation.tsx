...
export const FormGeneration = ({
    ...
    return (
        <form
            onSubmit={onSubmit}
            dir="rtl" // تنظیم جهت راست‌به‌چپ برای فارسی
            className="flex flex-col gap-2 flex-1 p-4 justify-between font-sans"
        >
            <div className="space-y-2">
                <div className="flex items-center gap-2">
                    <MessageCircle className="w-4 h-4 text-zinc-500" />
                    <span className="text-sm text-zinc-500">دستور (Prompt)</span>
                </div>
                <Input
                    type="text"
                    size={16}
                    defaultValue="تصویر یک زن با پس‌زمینه نارنجی"
                    placeholder="پرتره‌ای که می‌خواهید بسازید را توصیف کنید..."
