...
export default function AICardGeneration() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // شبیه‌سازی فرآیند تولید ویدیو
            await new Promise((resolve) => setTimeout(resolve, 3000));
            setShowForm(false);
        } catch (err) {
            setError("تولید ویدیو با خطا مواجه شد. لطفا دوباره تلاش کنید.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div dir="rtl" className="group relative overflow-hidden w-full max-w-sm bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)] min-h-[500px] flex flex-col justify-between gap-2 my-12 font-sans">
            <HeaderGeneration />
                            ...
                            <div className="space-y-4">
                                <div className="p-3 space-y-2 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-zinc-900 dark:text-zinc-100 font-mono" dir="ltr">
                                            1080p
                                        </span>
                                    </div>
                                    <div className="flex justify-between text-sm">
